  ...
  return (
    <Container>
      <PageContent>
        ...
        <p>
          <em>
            Just kidding. But, since I made an effort to write and publish the first volume for free*, I'll be very
            upset (and WILL enforce copyright) if you try to use it for commercial purposes. So please don't.{' '}
            <Link href="/book-two">
              <a>Help me</a>
            </Link>{' '}
            write the second one instead.
          </em>
        </p>
        ...
        <h2>The website</h2>
        <p>
          This website was built with JS, CSS, React, Next.js, Dragon's Blood resin and various other peculiar dark
          magic powders by{' '}
