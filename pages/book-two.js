        ...
        <div className="content-items">
          ...
          <div className="text">
            ...
            <p className="no-margin-bottom">
              What started off as an amusing personal exercise between projects, turned into taking a sabbatical to
              write the first book of <strong>{bookTitle}</strong>. A risky decision when you’ve never written anything
              before, nor have had any interest in it. But I did it anyway and I don't regret all the time spent carving
              this story. I hope that, imperfect and incomplete as it is, the book managed to bring a smile to your
              face.
            </p>
            <p className="no-margin-top no-margin-bottom">
              ...
              plan to complete the story in the future, but those bills don’t pay themselves, damn the little bitches.
              So it will take some time before the second part, still an embryo at the moment, will grow up into a
              proper book.
            </p>
            <p className="no-margin-top no-margin-bottom">
            ...
            <p className="no-margin-bottom">
              Bear in mind that any non-monetary gifts I receive shall be monetized, to cover living expenses. Unless
              it’s a small, cosy house on the beach—say, in Crete or Malta, or southern Spanish coast—in which case I
              shall gladly sell my own apartment and move there, which I’m certain will do wonders for my creativity.
              But no cars, please, I’m a bad driver.
            </p>
