...
const DisclaimerPage = () => (
  <Container>
    <PageContent>
      <h1>{TITLE}</h1>
      <p><em>
        This feels a bit awkward, but I have to say it:
      </em></p>
      <p>
      ...
      <p><em>
        This is even more awkward, but remember that:
      </em></p>
      <p>
        This book is not intended as a substitute for the medical advice of physicians.
        The reader should regularly consult a physician in matters relating to his/her health and
